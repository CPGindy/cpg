    ...
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        for index, picking in enumerate(lines):
            for line in picking.move_lines:
                ...
                sheet.write(counter, 15, line.picking_id.sale_id.date_order.date() if line.picking_id.sale_id.date_order else "", format3)
                ...
                sheet.write(counter, 23, line.picking_id.scheduled_date.date() if line.picking_id.scheduled_date else None, format3)
                sheet.write(counter, 24, line.picking_id.date_deadline.date() if line.picking_id.date_deadline else "", format3)
