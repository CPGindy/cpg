    ...
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        for index, picking in enumerate(lines):
            for line in picking.move_lines:
                ...
                sheet.write(counter, 20, line.picking_id.note if line.picking_id.note else "", format2)
                ...
                sheet.write(counter, 23, line.picking_id.scheduled_date if line.picking_id.scheduled_date else "", format3)
